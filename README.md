...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bcn7mhs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bcn7mhs.containers.anotherwebservice.com/
...
```
git clone git@github.com:arenaapptv-droid/container-bcn7mhs.git
cd container-bcn7mhs
```
...
```
docker attach container-bcn7mhs
```
